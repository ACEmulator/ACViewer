...
namespace ACViewer.Config
{
    public class KeyBindingConfig
    {
        ...
        public void SetBindingForAction(string actionName, GameKeyBinding binding)
        {
            switch (actionName)
            {
                case "Move Forward": MoveForward = binding; break;
                case "Move Backward": MoveBackward = binding; break;
                case "Strafe Left": StrafeLeft = binding; break;
                case "Strafe Right": StrafeRight = binding; break;
                case "Move Up": MoveUp = binding; break;
                case "Move Down": MoveDown = binding; break;
                case "Toggle Z-Level": ToggleZLevel = binding; break;
                case "Increase Z-Level": IncreaseZLevel = binding; break;
                case "Decrease Z-Level": DecreaseZLevel = binding; break;
                default:
